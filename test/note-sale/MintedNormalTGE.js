...
describe('MintedNormalTGE', () => {
    ...
    it('Setup newRoundSale', async () => {
        ...
        await expect(
            mintedNormalTGE.connect(accounts[0]).startNewRoundSale(openingTime, closingTime, rate, cap)
        ...
        await mintedNormalTGE.connect(owner).startNewRoundSale(openingTime, closingTime, rate, cap);
